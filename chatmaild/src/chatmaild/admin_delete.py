...
"""CGI script for deleting accounts through an admin endpoint."""
...
MAX_BODY_LEN = 4096
HELPER_BIN = "/usr/local/lib/chatmaild/venv/bin/chatmail-admin-delete-helper"
...
def parse_body():
    ...
    payload = {"email": params.get("email", [""])[0]}
    return payload, None
...
def main():
    ...
    # This CGI runs under fcgiwrap as www-data. Deleting a mailbox dir must be done
